...
class ViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.ourButton.setTitle("Рассчитать MMR", for: .normal)
    ...
    @objc func alert (sender:UIButton) {
        ourAlert(title: "Введите ваш рейтинг", message: "Пример: 1500", style: .alert)
        ourTextField.text = ""
        ourTextField2.text = ""
        ourTextField4.text = ("")
    }
    ...
    func ourAlert ( title:String, message:String, style:UIAlertController.Style ) {
        ...
        let buttonAction = UIAlertAction(title: "Подтвердить", style: .default) { (buttonAction) in
            ...
            let coast:Double = Double(text3) * 3.75
            var mmr = 0
            var day = 0
